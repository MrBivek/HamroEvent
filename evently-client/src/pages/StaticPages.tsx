        ...
        <div className="min-h-screen">
            ...
            <section className="gradient-hero py-16 md:py-24">
                <div className="container text-center">
                    ...
                    >
                        Nepal's premier event services marketplace, connecting customers with trusted vendors since
                        2024.
                    </motion.p>
                </div>
            </section>
                        ...
                        {[
                            {
                                icon: Target,
                                title: "Our Mission",
                                desc: "To simplify event planning in Nepal by connecting customers with verified, quality vendors."
                            },
                            {
                                icon: Award,
                                title: "Our Vision",
                                desc: "To become the most trusted event services platform across South Asia."
                            },
                            {
                                icon: Heart,
                                title: "Our Values",
                                desc: "Trust, quality, transparency, and exceptional customer experience in every interaction."
                            }
                        ].map((item, i) => (
