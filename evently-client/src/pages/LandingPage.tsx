        ...
        <div className="min-h-screen overflow-hidden">
            ...
            <section className="relative gradient-hero pt-12 pb-24 md:pt-20 md:pb-32">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div
                        className="absolute -bottom-40 -left-40 w-96 h-96 bg-secondary/5 rounded-full blur-3xl animate-float"
                ...
                >
                    <div className="max-w-3xl mx-auto text-center mb-10">
                        ...
                        >
                            Plan Your Perfect Event with <span className="text-gradient">Trusted Vendors</span>
                        </motion.h1>
                        ...
                        >
                            Discover and book verified event service providers across Nepal. From venues to photography,
                            catering to decoration – find everything you need.
                        </motion.p>
                    </div>
            ...
            <section className="py-16 md:py-24 gradient-wave">
                <div className="container">
                    ...
                    >
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Top-Rated Vendors</h2>
