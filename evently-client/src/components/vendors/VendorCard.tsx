    ...
    return (
        ...
        >
            <Link to={`/vendors/${vendor._id}`}>
                <Card
                    variant="interactive"
                    className="overflow-hidden group h-full hover:shadow-hover transition-shadow duration-300"
                >
                    {/* Image */}
                    ...
                    <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-border">
                            ...
                            <Button variant="soft" size="sm" className="group/btn">
                                View Details
                                <motion.span className="inline-block ml-1" initial={{ x: 0 }} whileHover={{ x: 2 }}>
                                    →
                                </motion.span>
                            </Button>
                        </div>
