...
export const mockVendors: VendorProfile[] = [
    {
        ...
        description:
            "Capturing your precious moments with artistic vision. We specialize in wedding, pre-wedding, and event photography with a team of experienced professionals.",
        location: "Kathmandu",
    ...
    },
    {
        ...
        category: "venue",
        description:
            "The most prestigious venue in Kathmandu for weddings and corporate events. Features stunning mountain views and modern amenities.",
        location: "Kathmandu",
    ...
    },
    {
        ...
        category: "catering",
        description:
            "Authentic Nepali and international cuisine for all events. Fresh ingredients, traditional recipes, modern presentation.",
        location: "Lalitpur",
    ...
    },
    {
        ...
        category: "decoration",
        description:
            "Transform any venue into a magical wonderland. Specializing in floral arrangements, lighting, and themed decorations.",
        location: "Bhaktapur",
        serviceAreas: ["Kathmandu", "Bhaktapur", "Lalitpur"],
        contact: {
    ...
    },
    {
        ...
        category: "makeup",
        description:
            "Bridal makeup experts with international training. We bring out your natural beauty for your special day.",
        location: "Kathmandu",
    ...
    },
    {
        ...
        category: "dj-music",
        description:
            "Professional DJ services for weddings, parties, and corporate events. State-of-the-art sound and lighting systems.",
        location: "Pokhara",
        ...
        portfolioMedia: ["https://images.unsplash.com/photo-1571266028243-d220c6a8e4cf?w=800"],
        packages: [
            {
                _id: "pkg-8",
